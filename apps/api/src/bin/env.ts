import { getListenAddr, getString, getBoolean, getEnum, getNumber } from '@efrei/toolbox'

export const GRAPHQL_SCHEMA_PATH = process.cwd() + '/node_modules/@efrei/graphql/src/schema.graphql'
